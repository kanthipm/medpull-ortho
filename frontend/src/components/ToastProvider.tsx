 ...
 *
 *  A toast is an `.overlay.glass-overlay` with pill corners: liquid glass at
 *  the overlay alpha floor (see Modal), the soft layered shadow, a leading Tile and a 14/500 ink label (17+ light / 12.810 dark on
...
function ToastView({
  ...
  return (
    <button
      ...
      className={`overlay glass-overlay pointer-events-auto flex min-h-11 max-w-full cursor-pointer items-center gap-2.5 !rounded-pill py-2 pl-2 pr-4 text-left text-copy font-medium text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus ${
